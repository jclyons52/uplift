...
- `eslint-deps.md` — module-graph / leaf-node analysis (`ts2go deps fmt/...`)
- `eslint-port-backlog.md` — the 21 leaf repos to port (registry-aware; excludes packages Go already covers)
- `npm-go-counterparts.md` — the npm→Go counterpart registry index (`ts2go registry`)
